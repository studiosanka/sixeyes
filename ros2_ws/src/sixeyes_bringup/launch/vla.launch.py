"""
SixEyes VLA inference mode bringup.

Starts 5 nodes required for VLA-driven arm control:
  ...
  - vla_inference_node : reads camera + joint state, publishes motor commands (stub)

Usage:
  ros2 launch sixeyes_bringup vla.launch.py
  ros2 launch sixeyes_bringup vla.launch.py port:=/dev/ttyACM1 baud:=115200
"""
